...
export const getOpenAIQuizExercise = async (
  ...
  const prompt = `Erstell ${amount === 1 ? "eine" : amount} Quiz-Aufgabe${amount > 1 ? "n" : ""} für das Thema "${topic}". Schreib für jede Frage: Die Frage in das Feld "question" und vier Antwortmöglichkeiten in das Feld "answers". Nummeriere die Antwortmöglichkeiten von "A" bis "D" und schreib dies in das Feld "id" der Antwortmöglichkeiten.`;
