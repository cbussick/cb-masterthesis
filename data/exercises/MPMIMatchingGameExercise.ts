...
export interface MPMIMatchingGameExercise extends MPMIExerciseWithTypeAndTopic {
  id: string;
  image: MPMIImgWithAlt;
  options: MPMIMatchingGameOption[];
  correctSelection: number[];
  highlightedComponents: MPMIMatchingGameHighlightComponent[];
  title: string;
  hint: string;
}

export const matchingGameExercises: MPMIMatchingGameExercise[] = [
  {
    id: "matching-game-1",
    type: MPMIExerciseType.MatchingGame,
    ...
    highlightedComponents: [
      {
        ...
        name: "Guanin",
        pointer: { x: 250, y: 205 },
        side: MPMIMatchingGameHighlightComponentSide.Left,
      },
      {
        id: 1,
        name: "Thymin",
        pointer: { x: 250, y: 5 },
        side: MPMIMatchingGameHighlightComponentSide.Right,
      },
      {
        id: 2,
        name: "Cytosin",
