...
export interface MPMIFreeformQuestionExercise
  extends MPMIExerciseWithTypeAndTopic {
  id: string;
  question: string;
  hint: string;
}

export const freeformQuestionExercises: MPMIFreeformQuestionExercise[] = [
  {
    id: "freeform-1",
    type: MPMIExerciseType.FreeformQuestion,
