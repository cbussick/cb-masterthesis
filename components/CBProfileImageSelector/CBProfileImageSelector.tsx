...
import {
  CBProfileImageSelectorProps,
  CBProfilePicture,
} from "./CBProfileImageSelectorInterfaces";

export const CBProfileImageSelector = ({
  onSelect,
}: CBProfileImageSelectorProps): JSX.Element => {
  const user = useUser();
  ...
  const checkIsLvlUnlocked = (image: CBProfilePicture) => {
