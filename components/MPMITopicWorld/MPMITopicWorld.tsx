...
import { MPMIProgressCircle } from "../MPMIProgressCircle/MPMIProgressCircle";
import { MPMIProgressCircleConnector } from "../MPMIProgressCircleConnector/MPMIProgressCircleConnector";

export const MPMITopicWorld = (): JSX.Element => {
  const user = useUser();
