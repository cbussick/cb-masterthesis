...
import { MPMIDeleteAccountDialogProps } from "./MPMIDeleteAccountDialogInterfaces";

interface DeleteAccountFormValues {
  password: string;
}

export const MPMIDeleteAccountDialog = ({
  isOpen,
  onClose,
}: MPMIDeleteAccountDialogProps): JSX.Element => {
  const user = useUser();
