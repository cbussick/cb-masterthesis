...
import { MPMIClassEvent, events } from "@/data/events";
...
export const MPMIDateCalendar = (): JSX.Element => {
  const currentDate = dayjs();
  const [calendarEvents, setCalendarEvents] = useState<MPMIClassEvent[]>(
