...
import { MPMIDateCalendarDayInformation } from "../MPMIDateCalendarDayInformation/MPMIDateCalendarDayInformation";
import { MPMIDateCalendarDayProps } from "./MPMIDateCalendarDayInterfaces";
...
export const MPMIDateCalendarDay = (props: MPMIDateCalendarDayProps) => {
  ...
  const highlightedDayEvents: MPMIClassEvent[] = events.filter(
  ...
  return (
    <>
      ...
      {highlightedDayEvents.length > 0 && (
        <MPMIDateCalendarDayInformation
