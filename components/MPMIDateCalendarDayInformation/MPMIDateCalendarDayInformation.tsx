...
import { MPMIDateCalendarDayInformationProps } from "./MPMIDateCalendarDayInformationInterfaces";

export const MPMIDateCalendarDayInformation = ({
  id,
  anchorEl,
  isOpen,
  onClose,
  events,
}: MPMIDateCalendarDayInformationProps): JSX.Element => {
  return (
    <Popover
      id={id}
      open={isOpen}
